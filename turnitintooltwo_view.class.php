            ...
            if (!empty($partid)) {
                ...
                if ($turnitintooltwouser->get_user_role() == 'Instructor') {
                    ...
                    $exportgrademarkzip = html_writer::link($CFG->wwwroot.'/mod/turnitintooltwo/view.php?id='.
										...
										$linkstyles = [ 'id' => 'dropdown_part_'.$partid, 'class' => 'btn dropdown-toggle turnitintooltwo-dropdown-toggle', 'disabled' => 'disabled', 'title' => get_string("download_button_warning", 'turnitintooltwo') ];
